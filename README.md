...
This plugin adds expression language support for SCM-Manager plugins.

## Usage

Find out how this plugin can be used on the [user documentation page](https://scm-manager.org/plugins/scm-el-plugin/docs).
